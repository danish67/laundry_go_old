...
class NearbyLaundry extends StatefulWidget {
  const NearbyLaundry({super.key});

  @override
  State<NearbyLaundry> createState() => _NearbyLaundryState();
}

class _NearbyLaundryState extends State<NearbyLaundry> {
  @override
